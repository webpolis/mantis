"""
Direct causal mask verification test (bypasses package imports).
"""
...
# Directly load the base_moe module without going through __init__.py
spec = importlib.util.spec_from_file_location(
    "base_moe",
    "/home/nico/dev/projects/hmst/hmst/models/base_moe.py"
)
base_moe = importlib.util.module_from_spec(spec)
spec.loader.exec_module(base_moe)

BaseMoEModel = base_moe.BaseMoEModel
